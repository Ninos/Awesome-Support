...
if ( $wpas_tickets->have_posts() ):
	...
	<div class="wpas wpas-ticket-list">
		<table id="wpas_ticketlist" class="table table-hover wpas-table wpas-table-hover">
			<thead>
				<tr>
		...
		<?php wpas_make_button( __( 'Open a ticket', 'wpas' ), array( 'type' => 'link', 'link' => esc_url( get_permalink( wpas_get_option( 'ticket_submit' ) ) ), 'class' => 'btn btn-default wpas-btn wpas-btn-default' ) ); ?>
	</div>
<?php else:
